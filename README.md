...
_Note: The recommended browser to use the PATTRN Platform is_ [Chrome](https://www.google.com/chrome/)_._

4.2 Navigation area

The main area, in the form of a map, is the navigation area. You can zoom in and out by using the + / - buttons, and change the base layer to display a choice of digital basemaps (see2.3.5 Configuring the baselayers of your map)
...
_Note: Only available if the Sharing Buttons have been set up. See_ _2.3.5 [Optional] Add sharing buttons to your PATTRN Platform__._
...
4.5 Submitting New Data and Edits
