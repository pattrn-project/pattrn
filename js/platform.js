...
d3.json("js/config.json", function(config) {
    ...
    $('#edit_dropdown').append(
        "<li><a target='_blank' href=" + config.editable_spreadsheet + "new" + " class='noMargin'>Add a new event</a></li>"
    );
    ...
    function consume_table(data) {
        ...
        // Highlight colour
        var highlightColour = settings[0].highlight_colour;
        ...
        var media_field_name = headers[27];
        ...
        var searchDimension = xf.dimension(function(d) {
            return [d.unique_event_ID, d.event_summary, d.sources, d.location_name,
        ...
        function text_filter(dim, queriedText) {
            ...
            // If there is a query in the textbox
            if (queriedText) {
        ...
        if (values_number_field_name_1 > 0) {
            ...
            line_chart_01.width(scatterWidth)
              ...
              .xAxisLabel(number_field_name_1 + " over time")
        ...
        if (values_number_field_name_2 > 0) {
            ...
            line_chart_02.width(scatterWidth)
                ...
                .renderHorizontalGridLines(true)
                .renderVerticalGridLines(true)
                .xAxisLabel(number_field_name_2 + " over time")
        ...
        if (values_number_field_name_3 > 0) {
            ...
            line_chart_03.width(scatterWidth)
                ...
                .title(function(d) { return ('Total number of events: ' + d.value ); })
                .x(d3.time.scale().domain(d3.extent(dataset, function(d) { return d.dd; })))
                .xAxisLabel(number_field_name_3 + " over time")
            ...
            SliderChart_03.width(125)
                ...
                .x(d3.scale.linear().domain(d3.extent(dataset, function(d) { return +d[number_field_name_3]; })))
                .xAxis();
        ...
        if (values_number_field_name_4 > 0) {
            ...
            var line_chart_04_title = document.getElementById('line_chart_04_title')
            .innerHTML = number_field_name_4 + " over time";
            ...
            line_chart_04.width(scatterWidth)
                ...
                .title(function(d) { return ('Total number of events: ' + d.value ); })
                .x(d3.time.scale().domain(d3.extent(dataset, function(d) { return d.dd; })))
                .xAxisLabel(number_field_name_4 + " over time")
        ...
        if (values_number_field_name_5 > 0) {
            ...
            line_chart_05.width(scatterWidth)
                ...
                .title(function(d) { return ('Total number of events: ' + d.value ); })
                .x(d3.time.scale().domain(d3.extent(dataset, function(d) { return d.dd; })))
                .xAxisLabel(number_field_name_5 + " over time")
        ...
        if (value_tags_field_name_1.length > 0) {
            ...
            var bar_chart_01_title = document.getElementById('bar_chart_01_title').innerHTML = "Events by " + tags_field_name_1;
            ...
            bar_chart_01
                .width(scatterWidth)
                .height(tagChartHeight) // 350
                .dimension(bar_chart_01_dimension)
                .group(bar_chart_01_group)
                .title(function(d) { return ('Total number of events: ' + d.value ); })
                .x(d3.scale.ordinal())
                .xUnits(dc.units.ordinal)
                .margins({top: 0, right: 10, bottom: 150, left: 4})
                .renderHorizontalGridLines(true)
                .xAxisLabel(bar_chart_01_title)
        ...
        if (value_tags_field_name_2.length > 0) {
            ...
            var bar_chart_02_title = document.getElementById('bar_chart_02_title').innerHTML = "Events by " + tags_field_name_2;
            ...
            bar_chart_02.width(scatterWidth)
                ...
                .title(function(d) { return ('Total number of events: ' + d.value ); })
                .x(d3.scale.ordinal())
                .margins({top: 0, right: 10, bottom: 200, left: 4})
                .xUnits(dc.units.ordinal)
                .renderHorizontalGridLines(true)
                .xAxisLabel(bar_chart_02_title)
                .yAxisLabel("no. of events")
                .renderlet(function (chart) {
                    chart.selectAll("g.x text")
                    .style("text-anchor", "end")
        ...
        if (value_tags_field_name_3.length > 0) {
            ...
            var bar_chart_03_title = document.getElementById('bar_chart_03_title').innerHTML = "Events by " + tags_field_name_3;
        ...
        if (value_tags_field_name_4.length > 0) {
            ...
            bar_chart_04
                .width(scatterWidth)
                .height(tagChartHeight - 100)
                .dimension(bar_chart_04_dimension)
                .group(bar_chart_04_group)
                .margins({top: 0, right: 10, bottom: 100, left: 4})
                .title(function(d) { return ('Total number of events: ' + d.value ); })
                .x(d3.scale.ordinal())
                .xUnits(dc.units.ordinal)
                .xAxisPadding(500)
                .renderHorizontalGridLines(true)
                .xAxisLabel(bar_chart_04_title)
                .yAxisLabel("no. of events")
                .elasticY(true)
                .renderlet(function (chart) {
                    chart.selectAll("g.x text")
        ...
        if (value_boolean_field_name_1.length > 0) {
            ...
            boolean_chart_01.width(scatterWidth)
                ...
                .xUnits(dc.units.ordinal)
                .renderHorizontalGridLines(true)
                .xAxisLabel(boolean_chart_01_title)
                .yAxisLabel("no. of events")
                .elasticY(true)
                .barPadding(0.1)
                .outerPadding(0.05);
        ...
        if (value_boolean_field_name_2.length > 0) {
            ...
            boolean_chart_02.width(scatterWidth)
                ...
                .xUnits(dc.units.ordinal)
                .renderHorizontalGridLines(true)
                .xAxisLabel(boolean_chart_02_title)
                .yAxisLabel("no. of events")
                .elasticY(true)
                .barPadding(0.1)
                .outerPadding(0.05);
        ...
        if (value_boolean_field_name_4.length > 0) {
            ...
            boolean_chart_04.width(scatterWidth)
                ...
                .xUnits(dc.units.ordinal)
                .renderHorizontalGridLines(true)
                .xAxisLabel(boolean_chart_04_title)
                .yAxisLabel("no. of events")
                .elasticY(true)
                .barPadding(0.1)
                .outerPadding(0.05);
        ...
        if (value_boolean_field_name_5.length > 0) {
            ...
            boolean_chart_05.width(scatterWidth)
                ...
                .xUnits(dc.units.ordinal)
                .renderHorizontalGridLines(true)
                .xAxisLabel(boolean_chart_05_title)
                .yAxisLabel("no. of events")
                .elasticY(true)
                .barPadding(0.1)
                .outerPadding(0.05);
        ...
        // timeline by EVENTS
            ...
            event_chart_01.width(scatterWidth)
                ...
                .renderHorizontalGridLines(true)
                .renderVerticalGridLines(true)
                .xAxisLabel("Number of Events over Time")
                .yAxisLabel("no. of events")
                .elasticY(true)
                .brushOn(true)
                .xAxis();
        ...
        if (media_field_name.length > 0) {
            ...
            media_chart
                ...
                .xAxisPadding(500)
                .renderHorizontalGridLines(true)
                .xAxisLabel('Events by Media Available')
                .yAxisLabel("no. of events")
                .elasticY(true)
                .filterHandler (function (dimension, filters) {
                    dimension.filter(null);
        ...
        dataset.forEach(function(d, i) {
            ...
            // Marker settings
            d.marker = new L.circleMarker(new L.LatLng(d.geo_latitude, d.geo_longitude),{
                title: "",
                radius: 7,
                color: "black",
                opacity:0.9,
            ...
            var eventDetailsContent = (
                ...
                "<p class='caption-grey'>EVENT ID:  </p><p class='noMargin'>" + d.unique_event_ID + "</p>" +
            ...
            var summaryContent = (
                ...
                "<p class='summary'>" + d.sources + "</p><br/>" +
            ...
            d.marker.on("click", function(e) {
                ...
                var file_gallery = document.getElementById("file_gallery").innerHTML = '';
                ...
                if (markerChart.filter() == e.target.data.i) {
                    ...
                    $('#edit_dropdown').append(
                        "<li><a target='_blank' href=" + config.editable_spreadsheet + d.unique_event_ID + " class='edit_dropdown noMargin'>Edit this event</a><li>"
                    );
                    ...
                    d3.json(e.target.data.photos, function(D) {
                        ...
                        for (j=0; j<json_photos.length; j++) {
                            $('#image_gallery').append(
                                ...
                                '" ><img src="' +
                                json_photos[j].thumb + '"/><p> Title: ' +
                                json_photos[j].title +  '<br/> Author: ' +
                                json_photos[j].author +'<br/> Caption: ' +
                                json_photos[j].caption + ' <br/> Date: ' +
                                json_photos[j].datetime+'</p></li>'
                            );
                        }
                    ...
                    // Videos
                    d3.json(e.target.data.embedded_videos, function(D) {

                        var json_videos = $.parseJSON('[' + dataset[i].embedded_videos + ']');

                        for (j=0; j<json_videos.length; j++) {
                            $('#video_gallery').append(
                                '<li data-src="' + json_videos[j].src +
                                '"data-sub-html="'+ json_videos[j].subhtml +'" id="image_link"><a href="#">Title: ' +
                                json_videos[j].title + '</a><p>Author: '+
                                json_videos[j].author +'<br/> Caption: '+
                                json_videos[j].caption + ' <br/> Date: '+
                                json_videos[j].datetime +'</p></li>'
                            );
                        }
                        $(document).ready(function() {
                    ...
                    // Files
                    d3.json(e.target.data.files, function(D) {

                        var array_files = $.parseJSON('[' + dataset[i].files + ']');
                        for (j=0; j<array_files.length; j++) {
                            // console.log(array_files[j]);
                            $('#file_gallery').append(
                                '<p> Title: <a href="' + array_files[j].url +'" target="_blank">' + array_files[j].title + '</a>'+
                                '<br/>Subtitle: ' + array_files[j].subtitle + '</p>'
                            );
                        }
                    ...
                    // Urls
                    d3.json(e.target.data.url_links, function(D) {

                        var array_urls = $.parseJSON('[' + dataset[i].url_links + ']');
                        // console.log(sample_files);

                        for (j=0; j<array_urls.length; j++) {
                            $('#urls').append(
                                '<p><a target="_blank" href="' + array_urls[j].url + '"> Title: ' + array_urls[j].title + '</a><br/>Subtitle: ' + array_urls[j].subtitle + '</p>'
                            );
                        }
    ...
    dc.markerChart = function(parent, chartGroup) {
        ...
        _chart._doRender = function() {
            ...
            // Baselayers
            var base_layer_01 = L.tileLayer(config.base_layer_01).addTo(_map);


            // Define basemaps and overlays
            var basemaps = {
                "Base Layer": base_layer_01,
            };
